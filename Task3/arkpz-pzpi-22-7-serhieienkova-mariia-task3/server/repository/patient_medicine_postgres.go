...
func (r *PatientMedicinePostgres) SetMedicineToPatient(patientMedicine structures.PatientMedicine) error {
	query := fmt.Sprintf("INSERT INTO %s (patient_id, medicine_id, date, schedule) VALUES ($1, $2, $3, $4)", patientMedicineTable)
	_, err := r.db.Exec(query, patientMedicine.PatientId, patientMedicine.MedicineId, patientMedicine.Date, patientMedicine.Schedule)
	return err
}
